          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="text-center space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold">
                Jogatina: <span className="text-primary">Termos de Serviço</span>
              </h1>
            ...
            <div className="prose prose-lg prose-invert max-w-none space-y-6">
              <p className="text-foreground/90 leading-relaxed">
                Ao utilizar o Jogatina, você concorda com os seguintes termos de serviço.
              </p>

              <h2 className="text-2xl font-semibold text-foreground mt-8">Aceitação dos Termos</h2>
              <p className="text-foreground/80">
                Ao baixar e usar o Jogatina, você aceita estar vinculado a estes termos de serviço.
              </p>

              <h2 className="text-2xl font-semibold text-foreground mt-8">Uso do Aplicativo</h2>
              <p className="text-foreground/80">
                O Jogatina é fornecido para uso pessoal e não comercial. Você concorda em usar o aplicativo para organizar e registrar suas sessões de jogos de tabuleiro.
              </p>

              <h2 className="text-2xl font-semibold text-foreground mt-8">Propriedade Intelectual</h2>
              <p className="text-foreground/80">
                O design, código e todos os elementos do Jogatina são protegidos por direitos autorais da MontBros.
              </p>
...
export default JogatinaTosPage;
